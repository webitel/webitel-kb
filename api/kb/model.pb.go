...
func (x *UpdateModelRequest) GetXJsonMask() []string {
	if x != nil {
		return x.XJsonMask
	}
	return nil
...
const file_model_proto_rawDesc = "" +
	...
	"\x05input\x18\x02 \x01(\v2\x1f.webitel.kb.InputEmbeddingModelR\x05input\x12\x1e\n" +
	"\vx_json_mask\x18\x03 \x03(\tR\txJsonMask\"$\n" +
