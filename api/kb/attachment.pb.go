...
func (x *AttachFileRequest) GetArticleEtag() string {
	if x != nil {
		return x.ArticleEtag
	}
	return ""
...
func (x *AttachFileRequest) GetFileId() int64 {
	if x != nil {
		return x.FileId
	}
	return 0
...
const file_attachment_proto_rawDesc = "" +
	...
	"webitel.kb\x1a\rgeneral.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1aproto/webitel/option.proto\"\xc1\x01\n" +
	"\x04File\x12\x0e\n" +
	...
	"\x03url\x18\a \x01(\tR\x03urlJ\x04\b\b\x10\t\"F\n" +
	"\bFileList\x12&\n" +
	...
	"\x04sort\x18\a \x01(\tR\x04sort\"O\n" +
	"\x11AttachFileRequest\x12!\n" +
	"\farticle_etag\x18\x01 \x01(\tR\varticleEtag\x12\x17\n" +
	"\afile_id\x18\x02 \x01(\x03R\x06fileId\"F\n" +
	"\x11DeleteFileRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12!\n" +
	"\farticle_etag\x18\x02 \x01(\tR\varticleEtag2\xfb\x02\n" +
	"\vAttachments\x12q\n" +
	"\tListFiles\x12\x1c.webitel.kb.ListFilesRequest\x1a\x14.webitel.kb.FileList\"0\x90\xb5\x18\x01\x82\xd3\xe4\x93\x02&\x12$/v1/kb/articles/{article_etag}/files\x12r\n" +
	"\n" +
	"AttachFile\x12\x1d.webitel.kb.AttachFileRequest\x1a\x10.webitel.kb.File\"3\x90\xb5\x18\x02\x82\xd3\xe4\x93\x02):\x01*\"$/v1/kb/articles/{article_etag}/files\x12t\n" +
	"\n" +
...
var file_attachment_proto_goTypes = []any{
	...
	(*AttachFileRequest)(nil), // 3: webitel.kb.AttachFileRequest
	(*DeleteFileRequest)(nil), // 4: webitel.kb.DeleteFileRequest
	(*ExtendedLookup)(nil),    // 5: general.ExtendedLookup
}
var file_attachment_proto_depIdxs = []int32{
	5, // 0: webitel.kb.File.created_by:type_name -> general.ExtendedLookup
	...
	3, // 3: webitel.kb.Attachments.AttachFile:input_type -> webitel.kb.AttachFileRequest
	4, // 4: webitel.kb.Attachments.DeleteFile:input_type -> webitel.kb.DeleteFileRequest
	1, // 5: webitel.kb.Attachments.ListFiles:output_type -> webitel.kb.FileList
	0, // 6: webitel.kb.Attachments.AttachFile:output_type -> webitel.kb.File
	0, // 7: webitel.kb.Attachments.DeleteFile:output_type -> webitel.kb.File
