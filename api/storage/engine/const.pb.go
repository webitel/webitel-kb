...
const file_const_proto_rawDesc = "" +
	...
	"\x04true\x10\x01\x12\t\n" +
	"\x05false\x10\x02B\x82\x01\n" +
	"\n" +
	"com.engineB\n" +
	"ConstProtoP\x01Z0github.com/webitel/webitel-kb/api/storage/engine\xa2\x02\x03EXX\xaa\x02\x06Engine\xca\x02\x06Engine\xe2\x02\x12Engine\\GPBMetadata\xea\x02\x06Engineb\x06proto3"
